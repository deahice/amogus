...
run:async (client, message, args) => {
  ...
  if (!args.length) {
    let embed = new MessageEmbed()
      .setColor("BLACK")
      .setDescription(`<:error:888328080110800926> Provide me song name or url link!`)
  ...
  if (!play) {
    ...
    if (!channel.joinable) {
      let embed = new MessageEmbed()
        ...
        .setDescription("<:error:888328080110800926> I an unable to join your voice channel")
      return message.channel.send(embed)
    }
